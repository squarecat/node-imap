...
export function sendInviteMail({ toAddress, organisationName }) {
  logger.info('email-utils: sending invite mail');
  return sendTransactionalMail({
    ...inviteOptions,
    subject: `${organisationName} has invited you to use Leave Me Alone`,
    to: toAddress,
    text: `You have been invited to use Leave Me Alone by ${organisationName}.\n\nLeave Me Alone is a service to easily unsubscribe from spam emails. As a member of the ${organisationName} organisation can unsubscribe from as many unwanted subscription emails as you like. Simply sign-up using this email address to start unsubscribing now.\n\nSign-in: https://leavemealone.app\n\nJames & Danielle\n\nLeave Me Alone`
  });
}
