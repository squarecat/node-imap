    ...
    <SubPageLayout>
      ...
      <ol type="a">
        ...
        <li>
          ...
          restrictions and may be terminated by Squarecat at any time. Upon
      ...
      <ol type="a">
        <li>
          The materials on Squarecat's website are provided on an 'as is' basis.
          Squarecat makes no warranties, expressed or implied, and hereby
        ...
        <li>
          Further, Squarecat does not warrant or make any representations
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall Squarecat or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption) arising out of the use or inability to use
        the materials on Squarecat's website, even if Squarecat or a Squarecat
      ...
      <p>
        The materials appearing on Squarecat's website could include technical,
        typographical, or photographic errors. Squarecat does not warrant that
        any of the materials on its website are accurate, complete or current.
        Squarecat may make changes to the materials contained on its website at
        any time without notice. However Squarecat does not make any commitment
        to update the materials.
      </p>
      <h3>6. Links</h3>
      <p>
        Squarecat has not reviewed all of the sites linked to its website and is
        not responsible for the contents of any such linked site. The inclusion
        of any link does not imply endorsement by Squarecat of the site. Use of
        any such linked website is at the user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        Squarecat may revise these terms of service for its website at any time
      ...
      <p>
        ...
        with the laws of Estonia and you irrevocably submit to the exclusive
